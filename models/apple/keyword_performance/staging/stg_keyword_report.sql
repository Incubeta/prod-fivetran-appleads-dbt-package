...
select
    ...
    -- Performance metrics
    SAFE_CAST(avg_cpa_amount AS FLOAT64) avg_cpa_amount,
    SAFE_CAST(avg_cpa_currency AS STRING) avg_cpa_currency,
    SAFE_CAST(avg_cpt_amount AS FLOAT64) avg_cpt_amount,
    SAFE_CAST(avg_cpt_currency AS STRING) avg_cpt_currency,
    SAFE_CAST(conversion_rate AS FLOAT64) conversion_rate,
    SAFE_CAST(impressions AS INT64) impressions,
    SAFE_CAST(total_installs AS INT64) installs,
    SAFE_CAST(lat_off_installs AS INT64) lat_off_installs,
    SAFE_CAST(lat_on_installs AS INT64) lat_on_installs,
    SAFE_CAST(local_spend_amount AS FLOAT64) local_spend_amount,
    SAFE_CAST(local_spend_currency AS STRING) local_spend_currency,
    SAFE_CAST(new_downloads AS INT64) new_downloads,
    SAFE_CAST(redownloads AS INT64) redownloads,
    SAFE_CAST(tap_through_rate AS FLOAT64) tap_through_rate,
    SAFE_CAST(taps AS INT64) taps,
    SAFE_CAST(localspend_amount AS FLOAT64) localspend_amount,
